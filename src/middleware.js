...
// --------------------------------------------------------------------------------------------------------------------------------
    //path specific vitore (alternative of matcher)
// --------------------------------------------------------------------------------------------------------------------------------
    //before login
...
// --------------------------------------------------------------------------------------------------------------------------------
 ...
 export const config = {
    matcher:'/api/:path*' // :path* = all, sudhu ai path a request asle execute hobe
    // matcher:['/api/:path*','/dashboard/:path*','/login/:path*'] // multiple paths
 }
